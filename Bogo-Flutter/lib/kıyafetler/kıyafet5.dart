...
class Kiyafet5 extends StatefulWidget {
  const Kiyafet5({Key? key}) : super(key: key);

  @override
  State<Kiyafet5> createState() => _Kiyafet5State();
}

class _Kiyafet5State extends State<Kiyafet5> {
  @override
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => Kiyafet4()));
                    },
                    backgroundColor: Colors.purple,
