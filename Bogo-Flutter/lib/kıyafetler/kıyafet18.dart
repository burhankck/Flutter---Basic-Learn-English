...
class Kiyafet18 extends StatefulWidget {
  const Kiyafet18({Key? key}) : super(key: key);

  @override
  State<Kiyafet18> createState() => _Kiyafet18State();
}

class _Kiyafet18State extends State<Kiyafet18> {
  @override
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => Kiyafet17()));
                    },
                    backgroundColor: Colors.purple,
