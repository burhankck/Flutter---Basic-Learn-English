...
import 'kıyafet3.dart';

class Kiyafet2 extends StatefulWidget {
  const Kiyafet2({Key? key}) : super(key: key);

  @override
  State<Kiyafet2> createState() => _Kiyafet2State();
}

class _Kiyafet2State extends State<Kiyafet2> {
  @override
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => Kiyafet1()));
                    },
                    backgroundColor: Colors.purple,
