...
class Kiyafet8 extends StatefulWidget {
  const Kiyafet8({Key? key}) : super(key: key);

  @override
  State<Kiyafet8> createState() => _Kiyafet8State();
}

class _Kiyafet8State extends State<Kiyafet8> {
  @override
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => Kiyafet7()));
                    },
                    backgroundColor: Colors.purple,
