...
import 'package:bogo/k%C4%B1yafetler/k%C4%B1yafet2.dart';
...
class Kiyafet1 extends StatefulWidget {
  const Kiyafet1({Key? key}) : super(key: key);

  @override
  State<Kiyafet1> createState() => _Kiyafet1State();
}

class _Kiyafet1State extends State<Kiyafet1> {
  @override
