...
import 'kıyafet4.dart';


class Kiyafet3 extends StatefulWidget {
  const Kiyafet3({Key? key}) : super(key: key);

  @override
  State<Kiyafet3> createState() => _Kiyafet3State();
}

class _Kiyafet3State extends State<Kiyafet3> {
  @override
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => Kiyafet2()));
                    },
                    backgroundColor: Colors.purple,
