...
class Kiyafet12 extends StatefulWidget {
  const Kiyafet12({Key? key}) : super(key: key);

  @override
  State<Kiyafet12> createState() => _Kiyafet12State();
}

class _Kiyafet12State extends State<Kiyafet12> {
  @override
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => Kiyafet11()));
                    },
                    backgroundColor: Colors.purple,
