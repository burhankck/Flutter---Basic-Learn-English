...
class Kiyafet10 extends StatefulWidget {
  const Kiyafet10({Key? key}) : super(key: key);

  @override
  State<Kiyafet10> createState() => _Kiyafet10State();
}

class _Kiyafet10State extends State<Kiyafet10> {
  @override
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => Kiyafet9()));
                    },
                    backgroundColor: Colors.purple,
