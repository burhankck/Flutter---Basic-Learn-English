...
class Renkler8 extends StatefulWidget {
  const Renkler8({Key? key}) : super(key: key);

  @override
  State<Renkler8> createState() => _Renkler8State();
}

class _Renkler8State extends State<Renkler8> {
  @override
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => Renkler7()));
                    },
                    backgroundColor: Colors.purple,
