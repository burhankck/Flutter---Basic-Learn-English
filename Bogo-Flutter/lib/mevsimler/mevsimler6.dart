...
import 'mevsimler7.dart';

class Mevsimler6 extends StatefulWidget {
  const Mevsimler6({Key? key}) : super(key: key);

  @override
  State<Mevsimler6> createState() => _Mevsimler6State();
}

class _Mevsimler6State extends State<Mevsimler6> {
  @override
