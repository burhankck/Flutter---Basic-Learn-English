...
class Mevsimler1 extends StatefulWidget {
  const Mevsimler1({Key? key}) : super(key: key);

  @override
  State<Mevsimler1> createState() => _Mevsimler1State();
}

class _Mevsimler1State extends State<Mevsimler1> {
  @override
