...
class Mevsimler13 extends StatefulWidget {
  const Mevsimler13({Key? key}) : super(key: key);

  @override
  State<Mevsimler13> createState() => _Mevsimler13State();
}

class _Mevsimler13State extends State<Mevsimler13> {
  @override
