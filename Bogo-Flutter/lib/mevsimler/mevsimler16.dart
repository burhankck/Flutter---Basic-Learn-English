...
import 'mevsimler17.dart';



class Mevsimler16 extends StatefulWidget {
  const Mevsimler16({Key? key}) : super(key: key);

  @override
  State<Mevsimler16> createState() => _Mevsimler16State();
}

class _Mevsimler16State extends State<Mevsimler16> {
  @override
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => Mevsimler15()));
                    },
                    backgroundColor: Colors.purple,
