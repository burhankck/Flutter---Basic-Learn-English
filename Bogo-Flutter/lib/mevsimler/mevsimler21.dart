...
class Mevsimler21 extends StatefulWidget {
  const Mevsimler21({Key? key}) : super(key: key);

  @override
  State<Mevsimler21> createState() => _Mevsimler21State();
}

class _Mevsimler21State extends State<Mevsimler21> {
  @override
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => Mevsimler20()));
                    },
                    backgroundColor: Colors.purple,
