...
import 'mevsimler21.dart';



class Mevsimler20 extends StatefulWidget {
  const Mevsimler20({Key? key}) : super(key: key);

  @override
  State<Mevsimler20> createState() => _Mevsimler20State();
}

class _Mevsimler20State extends State<Mevsimler20> {
  @override
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => Mevsimler19()));
                    },
                    backgroundColor: Colors.purple,
