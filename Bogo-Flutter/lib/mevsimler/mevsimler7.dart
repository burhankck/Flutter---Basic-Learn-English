...
import 'mevsimler6.dart';
import 'mevsimler8.dart';

class Mevsimler7 extends StatefulWidget {
  const Mevsimler7({Key? key}) : super(key: key);

  @override
  State<Mevsimler7> createState() => _Mevsimler7State();
}

class _Mevsimler7State extends State<Mevsimler7> {
  @override
