...
class Mevsimler14 extends StatefulWidget {
  const Mevsimler14({Key? key}) : super(key: key);

  @override
  State<Mevsimler14> createState() => _Mevsimler14State();
}

class _Mevsimler14State extends State<Mevsimler14> {
  @override
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => Mevsimler13()));
                    },
                    backgroundColor: Colors.purple,
