...
import 'package:bogo/mevsimler/mevsimler7.dart';
...
import 'mevsimler9.dart';

class Mevsimler8 extends StatefulWidget {
  const Mevsimler8({Key? key}) : super(key: key);

  @override
  State<Mevsimler8> createState() => _Mevsimler8State();
}

class _Mevsimler8State extends State<Mevsimler8> {
  @override
