...
import 'Teknoloji6.dart';



class Teknoloji5 extends StatefulWidget {
  const Teknoloji5({Key? key}) : super(key: key);

  @override
  State<Teknoloji5> createState() => _Teknoloji5State();
}

class _Teknoloji5State extends State<Teknoloji5> {
  @override
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => Teknoloji4()));
                    },
                    backgroundColor: Colors.purple,
