...
import 'Teknoloji2.dart';

class Teknoloji1 extends StatefulWidget {
  const Teknoloji1({Key? key}) : super(key: key);

  @override
  State<Teknoloji1> createState() => _Teknoloji1State();
}

class _Teknoloji1State extends State<Teknoloji1> {
  @override
