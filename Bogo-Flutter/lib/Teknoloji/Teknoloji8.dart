...
import 'Teknoloji9.dart';



class Teknoloji8 extends StatefulWidget {
  const Teknoloji8({Key? key}) : super(key: key);

  @override
  State<Teknoloji8> createState() => _Teknoloji8State();
}

class _Teknoloji8State extends State<Teknoloji8> {
  @override
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => Teknoloji7()));
                    },
                    backgroundColor: Colors.purple,
