...
import 'Teknoloji5.dart';

class Teknoloji4 extends StatefulWidget {
  const Teknoloji4({Key? key}) : super(key: key);

  @override
  State<Teknoloji4> createState() => _Teknoloji4State();
}

class _Teknoloji4State extends State<Teknoloji4> {
  @override
