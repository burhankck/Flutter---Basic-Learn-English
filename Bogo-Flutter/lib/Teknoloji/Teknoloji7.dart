...
class Teknoloji7 extends StatefulWidget {
  const Teknoloji7({Key? key}) : super(key: key);

  @override
  State<Teknoloji7> createState() => _Teknoloji7State();
}

class _Teknoloji7State extends State<Teknoloji7> {
  @override
