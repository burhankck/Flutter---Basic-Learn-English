...
import 'Teknoloji4.dart';



class Teknoloji3 extends StatefulWidget {
  const Teknoloji3({Key? key}) : super(key: key);

  @override
  State<Teknoloji3> createState() => _Teknoloji3State();
}

class _Teknoloji3State extends State<Teknoloji3> {
  @override
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => Teknoloji2()));
                    },
                    backgroundColor: Colors.purple,
