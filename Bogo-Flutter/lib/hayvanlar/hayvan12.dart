...
class HayvanSayfasi12 extends StatefulWidget {
  const HayvanSayfasi12({Key? key}) : super(key: key);

  @override
  State<HayvanSayfasi12> createState() => _HayvanSayfasi12State();
}

class _HayvanSayfasi12State extends State<HayvanSayfasi12> {
  @override
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => HayvanSayfasi11()));
                    },
                    backgroundColor: Colors.purple,
                      ...
                      child: FloatingActionButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => HayvanSayfasi13()));
                        },
                        backgroundColor: Colors.purple,
