...
class HayvanSayfasi6 extends StatefulWidget {
  const HayvanSayfasi6({Key? key}) : super(key: key);

  @override
  State<HayvanSayfasi6> createState() => _HayvanSayfasi6State();
}

class _HayvanSayfasi6State extends State<HayvanSayfasi6> {
  @override
