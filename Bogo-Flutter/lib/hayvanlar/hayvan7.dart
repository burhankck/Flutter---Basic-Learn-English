...
class HayvanSayfasi7 extends StatefulWidget {
  const HayvanSayfasi7({Key? key}) : super(key: key);

  @override
  State<HayvanSayfasi7> createState() => _HayvanSayfasi7State();
}

class _HayvanSayfasi7State extends State<HayvanSayfasi7> {
  @override
