...
class HayvanSayfasi1 extends StatefulWidget {
  const HayvanSayfasi1({Key? key}) : super(key: key);

  @override
  State<HayvanSayfasi1> createState() => _HayvanSayfasi1State();
}

class _HayvanSayfasi1State extends State<HayvanSayfasi1> {
  @override
