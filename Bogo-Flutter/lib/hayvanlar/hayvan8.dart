...
class HayvanSayfasi8 extends StatefulWidget {
  const HayvanSayfasi8({Key? key}) : super(key: key);

  @override
  State<HayvanSayfasi8> createState() => _HayvanSayfasi8State();
}

class _HayvanSayfasi8State extends State<HayvanSayfasi8> {
  @override
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => HayvanSayfasi7()));
                    },
                    backgroundColor: Colors.purple,
