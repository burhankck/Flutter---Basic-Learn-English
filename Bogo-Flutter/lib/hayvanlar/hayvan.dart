...
class HayvanSayfasi extends StatefulWidget {
  const HayvanSayfasi({Key? key}) : super(key: key);

  @override
  State<HayvanSayfasi> createState() => _HayvanSayfasiState();
}

class _HayvanSayfasiState extends State<HayvanSayfasi> {
  @override
