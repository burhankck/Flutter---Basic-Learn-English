...
class HayvanSayfasi11 extends StatefulWidget {
  const HayvanSayfasi11({Key? key}) : super(key: key);

  @override
  State<HayvanSayfasi11> createState() => _HayvanSayfasi11State();
}

class _HayvanSayfasi11State extends State<HayvanSayfasi11> {
  @override
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => HayvanSayfasi10()));
                    },
                    backgroundColor: Colors.purple,
                      ...
                      child: FloatingActionButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => HayvanSayfasi12()));
                        },
                        backgroundColor: Colors.purple,
