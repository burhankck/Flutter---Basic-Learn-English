...
class HayvanSayfasi3 extends StatefulWidget {
  const HayvanSayfasi3({Key? key}) : super(key: key);

  @override
  State<HayvanSayfasi3> createState() => _HayvanSayfasi3State();
}

class _HayvanSayfasi3State extends State<HayvanSayfasi3> {
  @override
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => HayvanSayfasi2()));
                    },
                    backgroundColor: Colors.purple,
                      ...
                      child: FloatingActionButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => HayvanSayfasi4()));
                        },
                        backgroundColor: Colors.purple,
