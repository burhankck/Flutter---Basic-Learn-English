...
class HayvanSayfasi18 extends StatefulWidget {
  const HayvanSayfasi18({Key? key}) : super(key: key);

  @override
  State<HayvanSayfasi18> createState() => _HayvanSayfasi18State();
}

class _HayvanSayfasi18State extends State<HayvanSayfasi18> {
  @override
