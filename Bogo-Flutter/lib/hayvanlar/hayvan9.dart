...
class HayvanSayfasi9 extends StatefulWidget {
  const HayvanSayfasi9({Key? key}) : super(key: key);

  @override
  State<HayvanSayfasi9> createState() => _HayvanSayfasi9State();
}

class _HayvanSayfasi9State extends State<HayvanSayfasi9> {
  @override
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => HayvanSayfasi8()));
                    },
                    backgroundColor: Colors.purple,
