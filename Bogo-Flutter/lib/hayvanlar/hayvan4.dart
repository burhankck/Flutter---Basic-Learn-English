...
class HayvanSayfasi4 extends StatefulWidget {
  const HayvanSayfasi4({Key? key}) : super(key: key);

  @override
  State<HayvanSayfasi4> createState() => _HayvanSayfasi4State();
}

class _HayvanSayfasi4State extends State<HayvanSayfasi4> {
  @override
                      ...
                      child: FloatingActionButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => HayvanSayfasi5()));
                        },
                        backgroundColor: Colors.purple,
