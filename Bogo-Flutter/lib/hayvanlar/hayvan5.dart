...
class HayvanSayfasi5 extends StatefulWidget {
  const HayvanSayfasi5({Key? key}) : super(key: key);

  @override
  State<HayvanSayfasi5> createState() => _HayvanSayfasi5State();
}

class _HayvanSayfasi5State extends State<HayvanSayfasi5> {
  @override
                      ...
                      child: FloatingActionButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => HayvanSayfasi6()));
                        },
                        backgroundColor: Colors.purple,
