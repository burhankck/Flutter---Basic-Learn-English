...
class HayvanSayfasi14 extends StatefulWidget {
  const HayvanSayfasi14({Key? key}) : super(key: key);

  @override
  State<HayvanSayfasi14> createState() => _HayvanSayfasi14State();
}

class _HayvanSayfasi14State extends State<HayvanSayfasi14> {
  @override
