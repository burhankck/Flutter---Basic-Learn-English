...
class HayvanSayfasi17 extends StatefulWidget {
  const HayvanSayfasi17({Key? key}) : super(key: key);

  @override
  State<HayvanSayfasi17> createState() => _HayvanSayfasi17State();
}

class _HayvanSayfasi17State extends State<HayvanSayfasi17> {
  @override
