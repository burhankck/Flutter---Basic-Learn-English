...
class Quizs1 extends StatefulWidget {
  const Quizs1({Key? key}) : super(key: key);

  @override
  State<Quizs1> createState() => _Quizs1State();
}

class _Quizs1State extends State<Quizs1> {
  @override
  var buttonText = 'Is';
  var buttonText2 = 'are ';
  var buttonText3 = 'At';
          ...
          setState(() {
            ...
            Future.delayed(
                ...
                () => Navigator.push(context,
                    MaterialPageRoute(builder: (context) => Quizs2())));
          });
        } else {
          setState(() {
            _start--;
