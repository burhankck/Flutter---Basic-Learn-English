...
class Quizs9 extends StatefulWidget {
  const Quizs9({Key? key}) : super(key: key);

  @override
  State<Quizs9> createState() => _Quizs9State();
}

class _Quizs9State extends State<Quizs9> {
  @override
  var buttonText = 'Is';
  var buttonText2 = 'Am ';
  var buttonText3 = 'They';
