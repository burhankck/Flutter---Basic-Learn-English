...
import 'package:bogo/Quizs2/Quizs9.dart';
import 'package:flutter/material.dart';
import 'package:flutter/src/foundation/key.dart';
import 'package:flutter/src/widgets/framework.dart';

class Quizs8 extends StatefulWidget {
  const Quizs8({Key? key}) : super(key: key);

  @override
  State<Quizs8> createState() => _Quizs8State();
}

class _Quizs8State extends State<Quizs8> {
  @override
  var buttonText = 'Going to';
  var buttonText2 = 'He';
  var buttonText3 = 'wont';
          ...
          setState(() {
            ...
            Future.delayed(
                ...
                () => Navigator.push(context,
                    MaterialPageRoute(builder: (context) => Quizs9())));
          });
        } else {
          setState(() {
            _start--;
