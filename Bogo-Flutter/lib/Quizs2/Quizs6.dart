...
import 'package:bogo/Quizs2/Quizs7.dart';
import 'package:flutter/material.dart';
import 'package:flutter/src/foundation/key.dart';
import 'package:flutter/src/widgets/framework.dart';

class Quizs6 extends StatefulWidget {
  const Quizs6({Key? key}) : super(key: key);

  @override
  State<Quizs6> createState() => _Quizs6State();
}

class _Quizs6State extends State<Quizs6> {
  @override
  var buttonText = 'He';
  var buttonText2 = 'She ';
  var buttonText3 = 'I';
          ...
          setState(() {
            ...
            Future.delayed(
                ...
                () => Navigator.push(context,
                    MaterialPageRoute(builder: (context) => Quizs7())));
          });
        } else {
          setState(() {
            _start--;
