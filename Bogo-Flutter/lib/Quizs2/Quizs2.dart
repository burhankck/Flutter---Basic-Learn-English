...
import 'package:bogo/Quizs2/Quizs3.dart';
import 'package:flutter/material.dart';
import 'package:flutter/src/foundation/key.dart';
import 'package:flutter/src/widgets/framework.dart';

class Quizs2 extends StatefulWidget {
  const Quizs2({Key? key}) : super(key: key);

  @override
  State<Quizs2> createState() => _Quizs2State();
}

class _Quizs2State extends State<Quizs2> {
  @override
  var buttonText = 'Is';
  var buttonText2 = 'Am ';
  var buttonText3 = 'At';
          ...
          setState(() {
            ...
            Future.delayed(
                ...
                () => Navigator.push(context,
                    MaterialPageRoute(builder: (context) => Quizs3())));
          });
        } else {
          setState(() {
            _start--;
