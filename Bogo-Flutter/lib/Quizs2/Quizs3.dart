...
import 'package:bogo/Quizs2/Quizs4.dart';
import 'package:flutter/material.dart';
import 'package:flutter/src/foundation/key.dart';
import 'package:flutter/src/widgets/framework.dart';

class Quizs3 extends StatefulWidget {
  const Quizs3({Key? key}) : super(key: key);

  @override
  State<Quizs3> createState() => _Quizs3State();
}

class _Quizs3State extends State<Quizs3> {
  @override
  var buttonText = 'Is';
  var buttonText2 = 'Am ';
  var buttonText3 = 'At';
          ...
          setState(() {
            ...
            Future.delayed(
                ...
                () => Navigator.push(context,
                    MaterialPageRoute(builder: (context) => Quizs4())));
          });
        } else {
          setState(() {
            _start--;
