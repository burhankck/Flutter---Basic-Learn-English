...
import 'package:bogo/Quizs2/Quizs8.dart';
import 'package:flutter/material.dart';
import 'package:flutter/src/foundation/key.dart';
import 'package:flutter/src/widgets/framework.dart';

class Quizs7 extends StatefulWidget {
  const Quizs7({Key? key}) : super(key: key);

  @override
  State<Quizs7> createState() => _Quizs7State();
}

class _Quizs7State extends State<Quizs7> {
  @override
  var buttonText = 'It';
  var buttonText2 = 'She ';
  var buttonText3 = 'He';
          ...
          setState(() {
            ...
            Future.delayed(
                ...
                () => Navigator.push(context,
                    MaterialPageRoute(builder: (context) => Quizs8())));
          });
        } else {
          setState(() {
            _start--;
