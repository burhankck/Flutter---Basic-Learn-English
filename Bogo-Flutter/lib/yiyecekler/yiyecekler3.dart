...
class yiyecekler3 extends StatefulWidget {
  const yiyecekler3({Key? key}) : super(key: key);

  @override
  State<yiyecekler3> createState() => _yiyecekler3State();
}

class _yiyecekler3State extends State<yiyecekler3> {
  @override
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => yiyecekler2()));
                    },
                    backgroundColor: Colors.purple,
