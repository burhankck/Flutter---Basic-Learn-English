...
class yiyecekler13 extends StatefulWidget {
  const yiyecekler13({Key? key}) : super(key: key);

  @override
  State<yiyecekler13> createState() => _yiyecekler13State();
}

class _yiyecekler13State extends State<yiyecekler13> {
  @override
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => yiyecekler12()));
                    },
                    backgroundColor: Colors.purple,
