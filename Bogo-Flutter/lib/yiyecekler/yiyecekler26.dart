...
class yiyecekler26 extends StatefulWidget {
  const yiyecekler26({Key? key}) : super(key: key);

  @override
  State<yiyecekler26> createState() => _yiyecekler26State();
}

class _yiyecekler26State extends State<yiyecekler26> {
  @override
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => yiyecekler25()));
                    },
                    backgroundColor: Colors.purple,
