...
class yiyecekler28 extends StatefulWidget {
  const yiyecekler28({Key? key}) : super(key: key);

  @override
  State<yiyecekler28> createState() => _yiyecekler28State();
}

class _yiyecekler28State extends State<yiyecekler28> {
  @override
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => yiyecekler27()));
                    },
                    backgroundColor: Colors.purple,
