...
class yiyecekler14 extends StatefulWidget {
  const yiyecekler14({Key? key}) : super(key: key);

  @override
  State<yiyecekler14> createState() => _yiyecekler14State();
}

class _yiyecekler14State extends State<yiyecekler14> {
  @override
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => yiyecekler13()));
                    },
                    backgroundColor: Colors.purple,
