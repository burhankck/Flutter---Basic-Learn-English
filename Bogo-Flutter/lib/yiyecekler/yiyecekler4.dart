...
class yiyecekler4 extends StatefulWidget {
  const yiyecekler4({Key? key}) : super(key: key);

  @override
  State<yiyecekler4> createState() => _yiyecekler4State();
}

class _yiyecekler4State extends State<yiyecekler4> {
  @override
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => yiyecekler3()));
                    },
                    backgroundColor: Colors.purple,
