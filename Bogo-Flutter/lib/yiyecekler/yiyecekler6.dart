...
class yiyecekler6 extends StatefulWidget {
  const yiyecekler6({Key? key}) : super(key: key);

  @override
  State<yiyecekler6> createState() => _yiyecekler6State();
}

class _yiyecekler6State extends State<yiyecekler6> {
  @override
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => yiyecekler5()));
                    },
                    backgroundColor: Colors.purple,
