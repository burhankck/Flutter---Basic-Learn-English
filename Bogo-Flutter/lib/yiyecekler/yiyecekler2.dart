...
class yiyecekler2 extends StatefulWidget {
  const yiyecekler2({Key? key}) : super(key: key);

  @override
  State<yiyecekler2> createState() => _yiyecekler2State();
}

class _yiyecekler2State extends State<yiyecekler2> {
  @override
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => yiyecekler1()));
                    },
                    backgroundColor: Colors.purple,
