...
class yiyecekler16 extends StatefulWidget {
  const yiyecekler16({Key? key}) : super(key: key);

  @override
  State<yiyecekler16> createState() => _yiyecekler16State();
}

class _yiyecekler16State extends State<yiyecekler16> {
  @override
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => yiyecekler15()));
                    },
                    backgroundColor: Colors.purple,
