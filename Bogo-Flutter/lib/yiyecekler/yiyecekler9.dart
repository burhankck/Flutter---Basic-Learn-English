...
class yiyecekler9 extends StatefulWidget {
  const yiyecekler9({Key? key}) : super(key: key);

  @override
  State<yiyecekler9> createState() => _yiyecekler9State();
}

class _yiyecekler9State extends State<yiyecekler9> {
  @override
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => yiyecekler8()));
                    },
                    backgroundColor: Colors.purple,
