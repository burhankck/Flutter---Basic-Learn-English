...
class yiyecekler17 extends StatefulWidget {
  const yiyecekler17({Key? key}) : super(key: key);

  @override
  State<yiyecekler17> createState() => _yiyecekler17State();
}

class _yiyecekler17State extends State<yiyecekler17> {
  @override
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => yiyecekler16()));
                    },
                    backgroundColor: Colors.purple,
