...
class yiyecekler1 extends StatefulWidget {
  const yiyecekler1({Key? key}) : super(key: key);

  @override
  State<yiyecekler1> createState() => _yiyecekler1State();
}

class _yiyecekler1State extends State<yiyecekler1> {
  @override
