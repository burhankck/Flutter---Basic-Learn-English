...
class yiyecekler27 extends StatefulWidget {
  const yiyecekler27({Key? key}) : super(key: key);

  @override
  State<yiyecekler27> createState() => _yiyecekler27State();
}

class _yiyecekler27State extends State<yiyecekler27> {
  @override
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => yiyecekler26()));
                    },
                    backgroundColor: Colors.purple,
