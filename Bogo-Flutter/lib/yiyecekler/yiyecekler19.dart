...
class yiyecekler19 extends StatefulWidget {
  const yiyecekler19({Key? key}) : super(key: key);

  @override
  State<yiyecekler19> createState() => _yiyecekler19State();
}

class _yiyecekler19State extends State<yiyecekler19> {
  @override
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => yiyecekler18()));
                    },
                    backgroundColor: Colors.purple,
