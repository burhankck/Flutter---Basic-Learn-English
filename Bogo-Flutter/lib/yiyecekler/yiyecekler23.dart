...
class yiyecekler23 extends StatefulWidget {
  const yiyecekler23({Key? key}) : super(key: key);

  @override
  State<yiyecekler23> createState() => _yiyecekler23State();
}

class _yiyecekler23State extends State<yiyecekler23> {
  @override
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => yiyecekler22()));
                    },
                    backgroundColor: Colors.purple,
